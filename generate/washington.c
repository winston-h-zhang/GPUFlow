...
int Range[] = {1000000, 500000, 250000, 125000, 62500, 31250, 15625,
               7812,    3906,   1953,   976,    488,   244,   122,
               61,      31,     15,     7,      4,     2};
...
Gadget(a, b, n, m, c, G) int a, b, n, m, c;
Graph *G;
{
  int i, j, v, w;
...
*/
RandomPermutation(perm, n) int perm[], n;
{
  int i, j, t;
...
be improved */
RandomSubset(low, high, n, x) int low, high, n, *x;
{
  int i, j, r, flag;
